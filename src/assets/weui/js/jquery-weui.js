...
+ function($) {
  ...
  $.alert = function(text, title, onOK, btnText) {
    var config;
    var myText;
  ...
  $.confirm = function(text, title, onOK, onCancel,arr) {
    var config;
    if (typeof text === 'object') {
      config = text
    } else {
...
+ function($) {
  ...
  Select.prototype._bind = function(dialog) {
    ...
    .on("click", ".close-clear", function () {
        self.$input.val('').data('weui-select', false);
        self.close();
    });
  }
  ...
  defaults = $.fn.select.prototype.defaults = {
    ...
    toolbarTemplate: '<div class="toolbar">\
      <div class="toolbar-inner">\
      <a href="javascript:;" class="picker-button close-clear">{{clearText}}</a>\
