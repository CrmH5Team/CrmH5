        ...
        <div class="box">
            ...
            <div v-show="showTips" class="tipBox">
                <div class="tipContent">
                    <p class="f12"><span class="red">*</span> <span class="zhuyi">{{tipsMessage}}</span></p>
                </div>
            </div>
            ...
            <div class="ListCell visible">
                ...
                <div class="OpportunitiesList">
                    ...
                    <div class="ListSpecialCell visible" id="TargetCompanyIDClickObj">
                        ...
                        <div class="ListSpecialCellContent" data-field="TargetCompanyID" data-fieldcontroltype="selectList" data-lanid="790_公司" data-fieldval="" data-selecttype="radio" code="DropDowList_ViewBaseCompanyBaseInf" typevalue="" data-clickObj="TargetCompanyIDClickObj"></div>
                    </div>
                    ...
                    <div class="ListCell" v-show="showPage==1">
                        ...
                        <div class="ListCellContent">
                            ...
                            <div class="ListCellContentRight rightContent">
                                <div class="ListCellContentRightText" data-field="ContactID" data-fieldcontroltype="selectList" data-lanid="791_联系人" data-fieldval="" data-selecttype="radio" Code="DropDowList_ViewBaseCompanyContactsByCompany"></div>
                            </div>
                            <div class="ListCellRightIcon"><span class="calcfont calc-you"></span></div>
                        </div>
                    </div>
                ...
                <InfoRightPanel ref="rightPanel" :isShowClose="isShowClose" :closeThisContent="closeThisContent" :isShowSend="isShowSendBtn" :rightPanelFromType="rightPanelFromType" :rightPanelFromID="rightPanelFromID"></InfoRightPanel>
...
export default {
    ...
    data() {
        return {
            ...
            closeThisContent: "",
            tipsMessage: lanTool.lanContent("897_请注意，该商业机会已关闭，仅允许被查看。"),
                ...
                tool.InitiateInfoPageControl(_self, _self.id, function () {
                    ...
                    tool.IniInfoData(fromType, _self.id, function (data) {
                        ...
                        if (data["CurrentState"] == "39") {
                            ...
                            _self.showTips = true;
                            if (_self.showPage === 1) {
                                _self.tipsMessage = lanTool.lanContent("897_请注意，该商业机会已关闭，仅允许被查看。")
                            } else {
                                _self.tipsMessage = lanTool.lanContent("984_请注意，该交易已关闭，仅允许被查看。")
                            }
